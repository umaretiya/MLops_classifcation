...
import os, sys,pandas as pd, numpy as np, uuid
...
class Pipeline(Thread):
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransformationArtifact) -> ModelTrainerArtifact:
        try:
            ...
            print(f"--pipelie----startmodeltrainer--->>>{model_trainer}<<<<<<<<<<<<-----model_trainer-------")
    ...
    def run_pipeline(self):
        try:
            ...
            # print(f"-------runpipline---->>>> {data_transformation_artifact}<<<<<<<<<<<_----------------data_transformation_artifact------\n")
