...
class BankingException(Exception):
    ...
    def __init__(self, error_message: Exception, error_detail:sys) -> None:
        ...
        self.error_message = BankingException.get_detail_error_message(error_message=error_message,
                                                                       error_detail=error_detail)
        
    @staticmethod
    def get_detail_error_message(error_message:Exception,error_detail:sys):
