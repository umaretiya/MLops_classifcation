...
from banking.entity.config_entity import (DataIngestionConfig,TrainingPipelineConfig,DataValidationConfig,DataTrasformationConfig,
...
class Configuration:
    ...
    def get_data_ingestion_config(self):
        try:
            ...
            dataset_file_name = data_ingestion_info[DATA_INGESTION_DOWNLOAD_FILE_NAME_KEY]
            dataset_zip_file_name = data_ingestion_info[DATA_INGESTION_DOWNLOAD_ZIP_FILE_NAME_KEY]
    ...
    def get_model_evaluation_config(self):
        try:
            ...
            artifact_dir = os.path.join(self.trainig_pipeline_config.artifact_dir,
    ...
    def get_training_pipeline_config(self):
        try:
            training_pipeline_config = self.config_info[TRAINING_PIPELINAE_CONFIG_KEY]
