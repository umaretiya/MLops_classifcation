...
class DataValidation:
    ...
    def __init__(self, data_validation_config:DataValidationConfig,
        ...
        try:
            ...
            # print(f"-\n------------self.data_validation_config-----------> {self.data_validation_config} <<<<<<<<<<<<---------------------\n\n---")
    ...
    def initiate_data_validation(self)->DataValidationArtifact :
        try:
            ...
            # print(f"-----schema_file_path --->>>>>>>> {self.data_validation_config.schema_file_path}  <<<<<<-------data_validation_artifact---------\n\n----")
            ...
            # print(f"------data_validation --->>>>>>>> {data_validation_artifact}  <<<<<<-------data_validation_artifact---------\n\n----")
